...
public interface Constants {
    ...
    final String CUSTOMER_SAMPLE_DATA = "./src/test/Resources/SampleTestData/customer_sample_data.xlsx";
    final String WEBSITE_SAMPLE_DATA = "./src/test/Resources/SampleTestData/website_sample_data.xlsx";
}